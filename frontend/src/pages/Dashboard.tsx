  ...
  return (
    ...
    <div className="flex flex-col gap-[16px]">
        <div className="flex items-center justify-between">
          ...
          <button className="text-sm leading-[1.4] text-[#ff1f69] font-medium underline tracking-[0.2px]">
            View Details
          </button>
        </div>
        <Chart
      ...
      <div className="flex flex-col gap-[16px]">
        <p className="text-base leading-[1.4] text-[#9e9e9e] font-medium tracking-[0.2px]">Quick Tasks</p>
