  ...
  return (
    ...
    <div className="flex flex-col gap-[16px]">
        <div className="flex items-center justify-between">
          ...
          <button className="text-sm leading-[1.4] text-tm-primary-color06 font-medium underline">
            View Details
          </button>
        </div>
        <Chart
      ...
      <div className="flex flex-col gap-[16px]">
        <p className="text-base leading-[1.4] text-tm-text-color08 font-medium">Quick Tasks</p>
