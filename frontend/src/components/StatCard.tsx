...
export const StatCard = ({ label, value, change, className = '' }: StatCardProps) => {
  ...
  return (
    <div
      className={`bg-gradient-to-t from-[#212121] to-[#23252a] border border-[rgba(255,255,255,0.03)] rounded-[8px] p-[16px] shadow-[0px_-1px_0px_0px_rgba(255,255,255,0.1),0px_2px_2px_0px_rgba(0,0,0,0.1),0px_8px_8px_-2px_rgba(0,0,0,0.05)] flex flex-col gap-[8px] items-end justify-center overflow-hidden ${className}`}
    >
