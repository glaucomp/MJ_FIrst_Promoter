...
export const Chart = ({ data, className = '' }: ChartProps) => {
  ...
  if (maxValue === null) {
    ...
    return (
      <div
        className={`bg-linear-to-t from-[#212121] to-[#23252a] border border-[rgba(255,255,255,0.03)] rounded-[8px] shadow-[0px_-1px_0px_0px_rgba(255,255,255,0.1),0px_2px_2px_0px_rgba(0,0,0,0.1),0px_8px_8px_-2px_rgba(0,0,0,0.05)] flex items-end justify-center p-[16px] ${className}`}
      >
            ...
            >
              <div
                className={`w-full rounded-[4px] transition-all ${
                  isHighlight
                    ? 'bg-linear-to-b from-[#ff0f5f] to-[#990033] border border-[#990033] shadow-[0px_-1px_0px_0px_rgba(255,255,255,0.1),0px_2px_2px_0px_rgba(0,0,0,0.1),0px_8px_8px_-2px_rgba(0,0,0,0.05)]'
                    : 'bg-[#3a3e48]'
                }`}
                style={{ height: `${height}%` }}
              />
