...
import { campaignAPI, dashboardAPI, referralAPI } from "../services/api";
...
const PromoterOverview = () => {
  ...
  return (
    <div>
      ...
      <div
        className="card"
        style={{ padding: "1.5rem", marginBottom: "2rem", background: "white" }}
      >
        <h3
          style={{
            fontSize: "1.25rem",
        ...
        <div style={{ display: "grid", gap: "1rem" }}>
            ...
            >
              <div>
                ...
                >
                  ...
                  >
                    {referral.referredUser?.firstName || "Pending"}{" "}
                    {referral.referredUser?.lastName || "User"}
                  </h4>
                  <span
                    style={{
                      ...
                      background:
                        referral.status === "ACTIVE"
                          ...
                          : "#667eea20",
                      color:
                        referral.status === "ACTIVE" ? "#48bb78" : "#667eea",
                    }}
                  >
                    {referral.status}
                  </span>
                ...
                <p
                  style={{ fontSize: "0.875rem", color: "#718096", margin: 0 }}
                >
                  Campaign: {referral.campaign.name} •{" "}
                  {referral.campaign.commissionRate}% commission
                </p>
              </div>
          ...
          {(!referrals?.referrals || referrals.referrals.length === 0) && (
            ...
            >
              ...
              <p>
                No referrals yet. Start inviting friends to earn commissions!
              </p>
              <button
                onClick={() => navigate("/referrals")}
                className="btn"
